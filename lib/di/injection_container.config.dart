...
import '../core/data/data_sources/cache_helper.dart' as _i13;
import '../core/data/services/database.dart' as _i5;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i13.CacheHelper>(
      _i13.CacheHelperImpl(get<_i8.SharedPreferences>()));
  gh.factory<_i14.SignInAnonymouslyUseCase>(() => _i14.SignInAnonymouslyUseCase(
      authRepository: get<_i10.AuthRepository>()));
  gh.singleton<_i15.AuthCubit>(
      _i15.AuthCubit(get<_i14.SignInAnonymouslyUseCase>()));
  gh.singleton<_i16.AuthStatusCubit>(
      _i16.AuthStatusCubit(get<_i12.AuthStatusUseCase>()));
  return get;
}
